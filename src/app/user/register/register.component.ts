...
export class RegisterComponent implements OnInit {
  ...
  onSubmit() {
    this.authenticationService.register(this.user.value.username, this.passwordControl.value, this.user.value.firstname, this.user.value.lastname, this.user.value.country, this.user.value.birthDate).subscribe(val => {
      if (val) {
